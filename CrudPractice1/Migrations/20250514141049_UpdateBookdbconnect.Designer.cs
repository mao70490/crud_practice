...
namespace CrudPractice1.Migrations
{
    ...
    [Migration("20250514141049_UpdateBookdbconnect")]
    partial class UpdateBookdbconnect
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrudPractice1.Models.BookCategory", b =>
                {
                    b.Property<int>("BookId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CrudPractice1.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CrudPractice1.Models.BookCategory", b =>
                {
                    b.HasOne("CrudPractice1.Models.Book", "Book")
                        .WithMany("BookCategories")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CrudPractice1.Models.Category", "Category")
                        .WithMany("BookCategories")
